function esccToggleGrid() {
    ...
    //  javascript:void ((function(){ if (typeof(esccToggleGrid) == 'undefined') { $.getScript('https://new.eastsussex.gov.uk/styleguide/grid.js').done(function(){esccToggleGrid();}) } else { esccToggleGrid();} })())
    
    $("<link href=\"https://new.eastsussex.gov.uk/styleguide/grid.css\" rel=\"stylesheet\" type=\"text/css\" />").appendTo('head');
