function esccToggleGrid() {
    ...
    //  javascript:void ((function(){ if (typeof(esccToggleGrid) == 'undefined') { $.getScript('https://www.eastsussex.gov.uk/styleguide/js/grid.js').done(function(){esccToggleGrid();}) } else { esccToggleGrid();} })())
    
    $("<link href=\"https://www.eastsussex.gov.uk/styleguide/css/grid.css\" rel=\"stylesheet\" type=\"text/css\" />").appendTo('head');
